				...
				<div class="contentInnerContainer">
					...
					<div class="contentColContainer">
						<div class="contentCollumn3">
							<div class="sociallink"><img src="images/profiles/avatar2.png" id="profilePicture"></div>
							<h5>CEO</h5>
							<p>Mollie Patel</p>
						</div>
						<div class="contentCollumn3">
						<div class="sociallink"><img src="images/profiles/avatar.png" id="profilePicture"></div>
							<h5>CFO</h5>
							<p>Luca Manning</p>
						</div>
						<div class="contentCollumn3">
							<div class="sociallink"><img src="images/profiles/avatar1.png" id="profilePicture"></div>
							<h5>CTO</h5>
							<p>Leon Bailey</p>
						</div>
					</div>
					<div class="contentColContainer">
							<div class="contentCollumn3">
								<div class="sociallink"><img src="images/profiles/avatar3.png" id="profilePicture"></div>
								<h5>Technical Manager</h5>
								<p>Ella Johnston</p>
							</div>
							<div class="contentCollumn3">
							<div class="sociallink"><img src="images/profiles/avatar4.png" id="profilePicture"></div>
								<h5>Head of Sales</h5>
								<p>Isabelle Brady</p>
							</div>
							<div class="contentCollumn3">
